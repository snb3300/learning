...
public class TwitterRequest
{
    ...
    public func equals(compareTo: TwitterRequest) -> Bool {
        return (self.requestType == compareTo.requestType) &&
                NSDictionary(dictionary: self.parameters).isEqualToDictionary(compareTo.parameters)
    }
